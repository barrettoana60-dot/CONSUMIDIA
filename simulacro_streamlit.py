...
st.set_page_config(page_title="Sala 3D – Eye Tracking + Blink Zoom", layout="wide")

st.title("Sala 3D com Eye Tracking + Blink Zoom + Parallax")
st.caption("Rastreamento ocular principal com contorno dos olhos + íris quando disponível, seleção por olhar na obra, 1 piscada afasta, 2 piscadas aproximam, com fallback pela cabeça quando a câmera enfraquece.")
